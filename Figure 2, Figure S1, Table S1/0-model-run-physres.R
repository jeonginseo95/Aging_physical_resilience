...
#ggsave("sPLS_physres.svg", plot = sPLS_physres, dpi =300, width = 10, height = 7)
...
#saveRDS(df_loadings_full, file = "0-ranked_metabolites-morbres.rds")
#write.csv(df_loadings_full, "0-ranked_metabolites-morbres.csv", row.names = FALSE)
...
hexplot_physres <- ggplot(df_loadings_full, aes(x = Weight, y = Stability)) +
